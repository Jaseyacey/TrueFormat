...
function TrustGrid() {
  return (
    <div className="mt-8 grid grid-cols-2 gap-4 border-t border-white/10 pt-7">
      <div className="flex flex-col border-l-2 border-[#38BDF8] pl-4">
      ...
      <div className="flex flex-col border-l-2 border-[#059669] pl-4">
...
function DiffCard({ title, rows, columns, tone }) {
  return (
...
export default function MarketingHomePage({ onPrimaryCta }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#020617]/90 text-[#F8FAFC] shadow-2xl shadow-black/45">
      ...
      <main className="relative mx-auto max-w-6xl space-y-10 px-6 pb-14 pt-8 lg:px-10 lg:pt-10">
        <section className="grid gap-8 rounded-2xl border border-white/10 bg-[#059669]/10 p-8 lg:grid-cols-12 lg:p-10">
          ...
          <aside className="lg:col-span-4">
            <div className="rounded-2xl border border-white/10 bg-[#27272A]/55 p-6 backdrop-blur-md">
              ...
              <div className="mt-4 space-y-3 text-sm text-[#CBD5E1]">
                <div className="rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2 font-mono">4.56E+12 → SKU corruption</div>
                <div className="rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2 font-mono">01/02/24 ↔ 02/01/24 ambiguity</div>
                <div className="rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2 font-mono">000123 → 123 leading zero loss</div>
                <div className="rounded-lg border border-[#EF4444]/30 bg-[#EF4444]/10 px-3 py-2 font-mono text-[#EF4444]">15-digit float rounding risk</div>
              </div>
            </div>
          </aside>
        </section>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div>
              ...
              <input
                ...
                className="mt-4 w-full rounded-lg border border-white/15 bg-[#020617] px-3 py-2 font-mono text-sm text-[#F8FAFC] outline-none transition focus:border-[#38BDF8] focus:ring-2 focus:ring-[#38BDF8]/30"
              />
              <div className="mt-4 rounded-lg border border-[#38BDF8]/35 bg-[#38BDF8]/10 p-4">
            ...
            <div>
              ...
              <pre className="mt-4 overflow-x-auto rounded-lg border border-white/10 bg-[#020617] p-4 text-xs text-[#CBD5E1]">
{`POST /v1/ingest\n{
        ...
        <section className="rounded-2xl border border-white/10 bg-[#27272A]/55 p-6 backdrop-blur-md">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-3 lg:grid-cols-5">
            {['NetSuite', 'Xero', 'SAP', 'Sage', 'Microsoft Dynamics'].map((name) => (
              <div key={name} className="rounded-lg border border-white/10 bg-white/[0.03] px-3 py-3 text-center text-sm text-[#CBD5E1]">
                {name}
              </div>
            ))}
          </div>
          <div className="mt-4 flex flex-wrap gap-3">
            <span className="rounded-full border border-white/15 bg-white/[0.03] px-3 py-1 text-xs text-[#94A3B8]">SOC 2 (In Progress)</span>
            <span className="rounded-full border border-white/15 bg-white/[0.03] px-3 py-1 text-xs text-[#94A3B8]">GDPR Controls</span>
            <span className="rounded-full border border-white/15 bg-white/[0.03] px-3 py-1 text-xs text-[#94A3B8]">Audit-Ready Logs</span>
          </div>
        </section>
      </main>

      <footer className="border-t border-white/10 bg-[#27272A]/55 px-6 py-6 text-center text-xs text-[#94A3B8]">
